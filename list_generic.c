...
{
  struct ListData *ldata = (struct ListData *)flayer->l_data;
  int count = 0;
...
{
    struct ListData *ldata = (struct ListData *)d;
...
{
  struct ListRow *r = (struct ListRow *)calloc(1, sizeof(struct ListRow));
  r->data = data;
