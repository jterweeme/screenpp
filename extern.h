...
extern void  WriteString (struct win *, const char *, int);
extern void  ChangeAKA __P((struct win *, char *, int));
extern void  SetCharsets __P((struct win *, const char *));
...
extern FILE *secfopen(const char *, const char *);
...
extern int   TtyGrabConsole __P((int, int, const char *));
...
/* input.c */
extern void  inp_setprompt (const char *, const char *);
extern void  Input __P((const char *, int, int, void (*)(char *, int, char *), char *, int));
extern int   InInput __P((void));

/* help.c */
extern void  exit_with_usage __P((const char *, const char *, char *));
...
extern void  display_bindkey(const char *, struct action *);
...
extern void DoScreen(const char *, char **);
...
extern int   WindowByNoN(const char *);
...
extern void AddCStr(const char *);
extern void AddCStr2(const char *, int);
...
extern void  AddStr __P((const char *));
...
#endif
extern void centerline(const char *, int);
extern void leftline(const char *, int, struct mchar *);
...
extern int   AclSetPerm __P((struct acluser *, struct acluser *, const char *, const char *));
...
extern struct acluser **FindUserPtr __P((const char *));
...
extern const char *EncodingName __P((int));
